...
- Layout: four indicators horizontally at centers (32,28), (96,28), (160,28), (224,28) with radius 12 and roman labels at (24,52), (88,52), (152,52), (216,52).
- Instantaneous draw: progress arcs are drawn in one pass (no animation yet).
- Icons:
  - Hardware (SSD1322): 1‑bit XBM bitmaps rendered via U8g2 (`drawXBMP`).
  - Native mock: the same XBM data is blitted in software for snapshots.
  - Current assets are placeholder 16×16 bitmaps in `lib/asap_display/src/asap/display/assets/AnomalyIcons.h` and will be replaced by proper art.
- Stages: roman numerals -, I, II, III shown under each icon. Future effects (double ring, blinking, pulses) can be added.
